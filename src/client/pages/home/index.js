            ...
            <Container maxWidth="xl" disableGutters>
              <Grid container className={classes.content}>
                <Grid item md={9} className={classes.leftPanel}>
                  <Title text="Cotizaciones del dolar" />
                  <Grid container spacing={1}>
                    ...
                    <Grid item xs={12} md={4}>
                      <Exchange title="Dolar Mayorista" base={{ coin: '$', value: 1 }} currency={blue} price={data.cotizaciones.usd.blue} />
                    </Grid>
                    <Grid item xs={12} md={4}>
                      <Exchange title="Dolar MEP" base={{ coin: '$', value: 1 }} currency={blue} price={data.cotizaciones.usd.blue} />
                    </Grid>
                    <Grid item xs={12} md={4}>
                      <Exchange title="Dolar CCL" base={{ coin: '$', value: 1 }} currency={blue} price={data.cotizaciones.usd.blue} />
                    </Grid>
                  </Grid>
                  <Separator />
                  <Title text="Otras divisas" />
                  <Grid container spacing={1}>
                ...
                <Grid item md={3} className={classes.rightPanel}>
                  <Title text="Articulos destacados" />
                  <Article />
                  <Article />
                  <Article />
                </Grid>
